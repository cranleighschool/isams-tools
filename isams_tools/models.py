...
class Student():
    ...
    def __init__(self, sync_value, forename, surname, username, email, academic_year, form, date_of_birth, gender):
        self.forename = forename
        self.surname = surname
        self.username = username
        self.email = email
...
class Department():
    ...
    def __init__(self, name, code, head_of_department, sync_value):
        self.name = name
        self.code = code
...
class Subject():
    ...
    def __init__(self, name, code, subject_leaders, department, sync_value):
        self.name = name
        self.code = code
